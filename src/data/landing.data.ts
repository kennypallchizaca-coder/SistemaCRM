 ...
 *   - Reemplaza estas constantes con llamadas a los servicios correspondientes.
 *   - Los componentes importarán los datos desde hooks en lugar de aquí.
 *   - Este archivo puede eliminarse o usarse como fallback (datos iniciales).
 *
 * Tipos: importados desde `src/types/landing.types.ts`
 */

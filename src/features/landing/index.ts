/** Agrupa las exportaciones públicas de la landing. */

export { default as Hero } from './components/Hero';
export { default as ViveLaCarrera } from './components/ViveLaCarrera';
export { default as GruposInvestigacion } from './components/GruposInvestigacion';

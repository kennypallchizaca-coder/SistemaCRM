        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-x-4">
              ...
              <a href={INSTITUTION.X_URL} target="_blank" rel="noopener noreferrer" className="bg-white/10 p-2.5 rounded-full hover:bg-ups-yellow hover:text-ups-dark transition-all flex items-center justify-center">
